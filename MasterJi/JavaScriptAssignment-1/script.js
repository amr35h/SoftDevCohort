...
const updateMoodModal = document.getElementById("updateMoodModal");
...
addMoodBtn.onclick = () => {
  addMoodModal.style.display = "block";
};
addModalCloseBtn.onclick = () => {
  addMoodModal.style.display = "none";
};
updateMoodBtn.onclick = () => {
  updateMoodModal.style.display = "block";
};
updateModalCloseBtn.onclick = () => {
